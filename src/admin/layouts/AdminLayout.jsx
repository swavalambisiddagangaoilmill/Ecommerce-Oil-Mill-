...
import { adminApi, adminAuthApi } from "../services/adminApi.js";
...
export default function AdminLayout() {
  ...
  useEffect(() => { adminAuthApi.profile().then((data) => setUser(data.user)).catch(() => setUser(null)); }, []);
